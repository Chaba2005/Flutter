...
void main() {
  runApp(
      MyApp()); //runApp - faz rodar, joga pra tela | widget é uma classe abstrata, ou seja, precisamos implemntá-la primeiro ou extendela
}
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        //barra de manu basicamente
        title: Text('Home'),
      ),
      body: Center(child: Text('Yeyyyy')),
    );
  }
}
